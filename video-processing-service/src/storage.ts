...
const storage = new Storage(); // NEW INSTANCE OF GCS so we can interact with it

// make sure the GCS bucket names have GLOBALLY UNIQUE name and EXIST (they might not as of now)
const rawVideoBucketName = "amj-yt-raw-videos";
const processedVideoBucketName = "amj-yt-processed-videos";
//////////////////////////////////////////////////////////////////
